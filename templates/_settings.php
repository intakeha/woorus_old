...
$(document).ready(function(){
	$.getJSON('../actions/lookupSettings.php', function(data) {
		...
		// Decode city name with HTML entities
		$("#city").val(decodeHTML(data.city_name));
	...
	// Clear cityID before user changes the city value
	$('#city').click(function() {
		$("#city_id").val('');
	});
...
<div id="settings_container" class="fluid">
    <div id="settings">
        <div id="change_settings">
            <form id="settings_form<?php if ($_SESSION['password_created']==0) echo "_c";?>" action="../actions/changeSettings.php" method="POST">
                <div id="settings_column1">
                    ...
                    <li><label>City</label><input class="text_form" type="text" id="city" name="city" maxlength="255"><input type="hidden" id="city_id" name="city_id" value="" /></li>
                    <li>&nbsp;</li>
                ...
                <div id="settings_column2">
                    ...
                    <li><input id="interest_notify" type="checkbox" name="interest_notify" value="Y"/> Has similar interests as you</li>
                    <li><input id="message_notify" type="checkbox" name="message_notify" value="Y"/> Sends you a message</li>
                    <li><input id="contact_notify" type="checkbox" name="contact_notify" value="Y"/> Adds you to a contact list</li>
                    <li><input id="missed_call_notify" type="checkbox" name="missed_call_notify" value="Y"/> Calls you while you're away</li>
                    </ul>
                    <input id="save_settings" class="buttons" type="submit" name="update" value="Save"><br />
                    <div id="settings_error" class="error_text"></div>
                    <div id="settings_success" class="success_text"></div>
                </div>
            </form>
        </div>        
